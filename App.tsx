...
const SplashScreen = ({ visible }: { visible: boolean }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] bg-[#0f172a] flex flex-col items-center justify-center transition-opacity duration-1000 animate-fade-out">
             ...
             <p className="text-slate-500 text-[10px] mt-4 font-mono tracking-widest">INITIALIZING MARKET DATA</p>
        </div>
    );
};
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-14 md:h-16">
            ...
            <div className="flex items-center gap-3">
               ...
               <div className="flex items-center gap-2">
                   {user && <img src={user.picture || "https://ui-avatars.com/api/?name=User&background=random"} alt="User" className="w-7 h-7 md:w-8 md:h-8 rounded-full border border-slate-600" />}
