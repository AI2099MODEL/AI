...
// Fix: Use React.Component explicitly to resolve TypeScript property missing errors on 'this'
class ErrorBoundary extends React.Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    ...
    // Correctly using this.setState from React.Component
    this.setState({ errorInfo });
  }

  render() {
    // Correctly accessing state from React.Component instance
    ...
    // Correctly accessing props from React.Component instance
